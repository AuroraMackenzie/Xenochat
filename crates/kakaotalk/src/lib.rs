...
impl Default for KakaoTalkAdapter {
    fn default() -> Self {
        Self {
            adapter: BasicAdapter::new(Platform::KakaoTalk, 4096, false),
        }
    }
}

impl PlatformAdapter for KakaoTalkAdapter {
...
impl ImportContract for KakaoTalkAdapter {
