...
impl Default for SkypeAdapter {
    fn default() -> Self {
        Self {
            adapter: BasicAdapter::new(Platform::Skype, 4096, false),
        }
    }
}

impl PlatformAdapter for SkypeAdapter {
...
impl ImportContract for SkypeAdapter {
